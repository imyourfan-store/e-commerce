          ...
          <div className="contenedor-slider">
            <div className="slider">
              <div className="slide fade">
                <img src="/src/img/Logo IYF Opaco - Marca de Agua.jpg" alt="imagen de muestra 1" />
              </div>
              <div className="slide fade">
                <img src="/src/img/Logo IYF Colors.jpg" alt="imagen de muestra 2" />
              </div>
            </div>
            <a href="#" className="prev"><i className="fas fa-chevron-left"></i></a>
            <a href="#" className="next"><i className="fas fa-chevron-right"></i></a>
